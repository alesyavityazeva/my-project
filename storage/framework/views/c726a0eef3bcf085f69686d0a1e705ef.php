...
<body>
    <form action="<?php echo e(route('register.submit')); ?>" method="post">
        ...
        <p class="auth-link">
            У вас уже есть аккаунт? <a href="<?php echo e(route('login')); ?>">Войти</a>
        </p>
        <?php if(session('message')): ?>
            <p class="msg"><?php echo e(session('message')); ?></p>
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <p class="msg"><?php echo e($errors->first()); ?></p>
        <?php endif; ?>
    </form>
</body>
<script>
...
<?php /**PATH C:\Users\alesy\OneDrive\Рабочий стол\PHP Coursach\resources\views/auth/register.blade.php ENDPATH**/ ?>